...
mysqldump --password=$MYSQL_REMOTE_PASSWORD -u hubuser -h experimenthub.bioconductor.org experimenthub | gzip > /tmp/dump.sql.gz
...
curl http://experimenthub.bioconductor.org:3000/metadata/experimenthub.sqlite3 >
